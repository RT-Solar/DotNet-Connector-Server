	...
	public class Service : ServiceBase
	{
		...
		protected override void OnStart(string[] args)
		{
		    try {		        
    		    ...
    		    LOG.Info("Starting connector server: " + Environment.CurrentDirectory);
    		    NameValueCollection settings =
    		        GetApplicationSettings();
    		    String portStr =
    		    ...
    		    _server.Start();
    		    LOG.Info("Started connector server");
		    }
		    catch (Exception e) {
		        LOG.Error(e, "Exception occured starting connector server");
		        throw;
		    }
		}
		...
		protected override void OnStop()
		{
		    try {
    		    ...
    		    LOG.Info("Stopped connector server");
		    }
		    catch (Exception e) {
		        LOG.Error(e, "Exception occured stopping connector server");
		    }
		}
	}
}
